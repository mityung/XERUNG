...
- (void)badgeInit
{
    ...
    self.badgeBGColor   = [UIColor colorWithRed:209.0/255.0 green:4.0/255.0 blue:4.0/255.0 alpha:1.0];
...
-(UILabel*) badge {
    ...
    if(lbl==nil) {
        lbl = [[UILabel alloc] initWithFrame:CGRectMake(self.badgeOriginX, self.badgeOriginY, 10, 10)];
        [self setBadge:lbl];
        [self badgeInit];
