...
public class PublicGroupAdapter extends ArrayAdapter<GroupBean> {
     ...
     */
    public PublicGroupAdapter(Context ncontext, int resource, ArrayList<GroupBean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PublicGroupAdapter.ViewHolder viewHolder = null;
        LayoutInflater inflate = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        GroupBean tb = data.get(position);
        if (convertView == null) {

            viewHolder = new PublicGroupAdapter.ViewHolder();
            convertView = inflate.inflate(R.layout.public_group_list_item, null);
            ...
            viewHolder = (PublicGroupAdapter.ViewHolder) convertView.getTag();
        }
